      ...
      <div className="flex gap-2 justify-center mx-10">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              <span>Add a new item using this option</span>
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Link
      ...
      <div className="flex gap-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              View all the current brands using this option
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Link
      ...
      <div>
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Select this option if you want to edit the banner of home page
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Link
              className="bg-cyan-900 text-white p-2 rounded"
              href="/banner/new-banner"
            >
              Add New Banner
            </Link>
          </CardContent>
