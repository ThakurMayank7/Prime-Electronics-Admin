...
const formDataDisplay = new FormData();
        ...
        formDataDisplay.append("folder", "primeElectronics/draft");
      ...
      catch(error)
      {
        toast("Error Occurred", {
          description: "Could not Create this Item : "+error+". At " + format(now.toISOString(), "yyyy-MM-dd HH:mm:ss"),
          action: null,
        });
      }
      finally{
setCreating(false)
  ...
  return (
    ...
    <div>
      ...
      <span className="text-4xl font-semibold">Creating the item! Please wait...</span>
      <Spinner/>
      </div>
      ...
      <div className="border-2 border-black p-4">
        <div className="flex justify-center">
          <span className="text-2xl font-semibold">
            {publicId ? "Preview of Display Image" : "Select Display Image"}
          </span>
        </div>
    ...
    <input
      ...
      <button
              ...
              className={`p-2 rounded ${!uploadingImages?'bg-teal-200 hover:bg-teal-500':"bg-teal-700"}`}
